...
ACCC의 12~27 PJ 잉여 전망은 Senex 증산의 안전판처럼 보이지만 남부 운송·저장·한파·발전수요에 조건부입니다. 총량보다 고정 인도계약과 실제 전송권을 우선 확인해야 합니다.
...
flowchart LR
 ...
 C --> D[Senex 계약가격·인도비용·현금회수 시점]
 D --> E[증산 CAPEX 회수 및 POSCO International 연결이익]
```
